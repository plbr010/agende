...
export function MarketingHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-xl">
      <div className="relative z-50 mx-auto flex h-16 w-full min-w-0 max-w-6xl items-center justify-between gap-2 px-4 sm:h-[4.25rem] sm:gap-3">
        ...
        <div className="flex min-w-0 items-center gap-1.5 sm:gap-2">
          ...
          <MarketingLinkButton
            href={MARKETING_CTAS.headerPrimary.href}
            className="h-11 min-h-11 rounded-full px-3 text-sm sm:px-4"
          >
      ...
      {open ? (
        <div className="lg:hidden">
          ...
          <div
            id={panelId}
            className="absolute inset-x-3 top-full z-50 mt-2 rounded-3xl border border-border/80 bg-background/95 p-3 shadow-[0_24px_60px_-28px_oklch(0.4_0.05_25/0.45)] backdrop-blur-xl sm:inset-x-auto sm:right-4 sm:left-auto sm:w-[22rem]"
          >
